defmodule ExshomeWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="flex items-center flex-col max-h-full w-full overflow-x-hidden overflow-y-auto my-2">
  ...
  def live_form(assigns) do
    ...
    >
      <.input
        ...
        options={if data[:allowed_values], do: data[:allowed_values].()}
      />
      <:actions>
  ...
  """
  attr :type, :string, default: nil, doc: "custom button styles"
  attr :class, :string, default: nil, doc: "button type"
  attr :rest, :global, include: ~w(disabled form name value), doc: "extra button attributes"

  slot :inner_block, required: true, doc: "inner button content"
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        "enabled:hover:bg-gray-300 enabled:dark:hover:bg-gray-500",
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "w-full p-2 rounded-lg bg-gray-100 dark:bg-gray-800 shadow-md dark:shadow-gray-700",
          @errors == [] && "border-zinc-300 focus:border-zinc-400",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExshomeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExshomeWeb.Gettext, "errors", msg, opts)
    end
  end
